...
include(":chimera-app:chimera-migration")
include(":chimera-app:chimera-testkit")

include(":chimera-ext-app:chimera-ext-app-flyway")
include(":chimera-ext-app:chimera-ext-app-service")
include(":chimera-ext-app:chimera-ext-migration")
