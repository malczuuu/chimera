        ...
        settings {
            runConfigurations {
                create<Application>("launch chimera-app-flyway") {
                    ...
                    moduleName = "chimera-project.chimera-app.chimera-app-flyway.main"
                ...
                create<Application>("launch chimera-app-service") {
                    ...
                    moduleName = "chimera-project.chimera-app.chimera-app-service.main"
                    workingDirectory = rootProject.rootDir.absolutePath
                    programParameters = ""
                }
                create<Application>("launch chimera-ext-app-flyway") {
                    mainClass = "io.github.malczuuu.chimera.ext.app.flyway.ExtFlywayApplication"
                    moduleName = "chimera-project.chimera-ext-app.chimera-ext-app-flyway.main"
                    workingDirectory = rootProject.rootDir.absolutePath
                    programParameters = ""
                }
                create<Application>("launch chimera-ext-app-service") {
                    ...
                    moduleName = "chimera-project.chimera-ext-app.chimera-ext-app-service.main"
                    workingDirectory = rootProject.rootDir.absolutePath
                    programParameters = ""
                }
